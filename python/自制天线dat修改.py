...
SWAP_CONFIG_PLUGIN = [
    ...
    (802422, 413508),    # 背包挂件-无面战甲 <=> 沙丘3  
    # (802416, 413820),    # 背包挂件-异域银装 <=> 瑞拉3
    # (802055, 413820),    # 背包挂件-黑色刀锋 <=> 瑞拉3
    # (802040, 413820),    # 背包挂件-华贵君王 <=> 瑞拉3
    # (802496, 413820),    # 背包挂件-狂鲨锋刃 <=> 瑞拉3 
...
def main():
    # 直接指定要处理的 dat 文件
    target_dat = Path("./release/RE天线V4发布20250930/00000208原厂（复件）.dat")
