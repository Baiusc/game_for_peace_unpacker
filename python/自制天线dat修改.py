...
def main():
    # 直接指定要处理的 dat 文件
    # target_dat = Path("./release/RE天线V4发布20250930/BattleItem.uasset") #  BattleItem
    ...
    target_dat = Path("./release/RE天线V4发布20250930/AvatarBPTable.uasset") # AvatarBPTable 
